...
S.EasePack = {
    ...
    BackIn: function (m) {
        return m * m * ((e.s + 1) * m - e.s)
    },
    BackOut: function (m) {
        return (m = m - 1) * m * ((e.s + 1) * m + e.s) + 1
    },
    ...
    SwingFromTo: function (m) {
        return ((m /= 0.5) < 1) ? 0.5 * (m * m * (((e.s *= (e.r)) + 1) * m - e.s)) : 0.5 * ((m -= 2) * m * (((e.s *= (e.r)) + 1) * m + e.s) + 2)
    },
    SwingFrom: function (m) {
        return m * m * ((e.s + 1) * m - e.s)
    },
    SwingTo: function (m) {
        return (m -= 1) * m * ((e.s + 1) * m + e.s) + 1
    },
    Bounce: function (m) {
        if (m < 1 / e.x) {
            return (e.v * m * m)
